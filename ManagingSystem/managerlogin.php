<?php
	...
	$result = mysqli_query($db, "SELECT * FROM managers WHERE username = '$username' AND password = '$password'");
	...
	<div class="login-page">
  		<div class="form">
			...
			<form action="managerlogin.php" method="POST">
				<div class="input">
					<input class="username" type="text" name="username" placeholder="username" required="true"></input>
				</div>
				<br>
				<div class="input">
